...
namespace DResume.Api.Data.Migrations
{
    ...
    [Migration("20260601075929_AddPortfolioSites")]
    partial class AddPortfolioSites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DResume.Api.Data.Entities.AiProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DResume.Api.Data.Entities.BankPricingTier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlanCode", "Months")
                        .IsUnique();

                    b.ToTable("bank_pricing_tiers", "resume");
                });
            ...
            modelBuilder.Entity("DResume.Api.Data.Entities.PortfolioSite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("portfolio_sites", "resume");
                });
            ...
            modelBuilder.Entity("DResume.Api.Data.Entities.PortfolioSite", b =>
                {
                    b.HasOne("DResume.Api.Data.Entities.Resume", null)
                        .WithMany()
